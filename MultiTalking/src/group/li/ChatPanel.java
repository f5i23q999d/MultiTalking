	...
	public ChatPanel(String name) {
		...
		sendButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				// System.out.println("listID:"+list.get(n).ID+"
				// context:"+list.get(n).getDocument().getText(0,
				// list.get(n).getDocument().getLength()));
				/////////////////
				...
				// System.out.println(UI.panel_2.nameTitle.getText()+" :
